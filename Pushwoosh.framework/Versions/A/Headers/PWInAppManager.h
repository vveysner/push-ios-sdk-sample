 ...
 */
- (void)setUserId:(NSString *)userId withAppCode:(NSString *)appCode;
 ...
 */
- (void)mergeUserId:(NSString *)oldUserId to:(NSString *)newUserId doMerge:(BOOL)doMerge appCode:(NSString *)appCode completion:(void (^)(NSError *, NSString *appCode))completion;
/**
 ...
 */
- (void)postEvent:(NSString *)event withAttributes:(NSDictionary *)attributes appCode:(NSString *)appCode completion:(void (^)(NSError* error, NSString *appCode))completion;

/**
 See `postEvent:withAttributes:completion:`
 */
- (void)postEvent:(NSString *)event withAttributes:(NSDictionary *)attributes appCode:(NSString *)appCode;
