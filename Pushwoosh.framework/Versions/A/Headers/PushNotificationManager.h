...
#define PUSHWOOSH_VERSION @"5.3.2-34-ga455941"
...
typedef void (^PushwooshGetTagsHandler)(NSDictionary *tags, NSString *appCode);
typedef void (^PushwooshErrorHandler)(NSError *error, NSString *appCode);
...
/**
 Current Pushwoosh Application ID's.
 */
@property (nonatomic, copy, readonly) NSSet<NSString *> *appCodes;
 ...
 */
+ (void)initializeWithAppName:(NSString *)appName;

/**
 Deprecated. Use initializeWithAppName: method instead.
 @param appCode Pushwoosh App ID.
 @param appName Application name.
 */
+ (void)initializeWithAppCode:(NSString *)appCode appName:(NSString *)appName __attribute__((unavailable("This method is deprecated starting in version 5.3.2, please use initializeWithAppName: method instead.")));
...
/**
 Add Pushwoosh App ID.
 @param appCode Pushwoosh App ID.
 */
- (void)addPushAppCode:(NSString *)appCode;

/**
 Remove Pushwoosh App ID with completion block. If remove succeeds competion is called with nil argument. If remove fails completion is called with error.
 @param appCode Pushwoosh App ID.
 */
- (void)removePushAppCode:(NSString *)appCode completionHandler:(void (^)(NSError *error, NSString *appCode))completionHandler;
...
/** Deprecated. Use initWithAppName: method instead.
 @param appCode Pushwoosh App ID.
 @param appName Application name.
 */
- (instancetype)initWithApplicationCode:(NSString *)appCode appName:(NSString *)appName __attribute__((unavailable("This method is deprecated starting in version 5.3.2, please use initWithAppName: method instead.")));;
 ...
 */
- (void)setTags:(NSDictionary *)tags withAppCode:(NSString *)appCode;
 ...
 */
- (void)setTags:(NSDictionary *)tags withAppCode:(NSString *)appCode completionHandler:(PushwooshErrorHandler)completionHandler;
 ...
 */
- (void)loadTagsWithAppCode:(NSString *)appCode successHandler:(PushwooshGetTagsHandler)successHandler errorHandler:(PushwooshErrorHandler)errorHandler;
 ...
 */
- (void)sendSKPaymentTransactions:(NSArray *)transactions withAppCode:(NSString *)appCode;
#endif
 ...
 */
- (void)sendPurchase:(NSString *)productIdentifier withPrice:(NSDecimalNumber *)price currencyCode:(NSString *)currencyCode andDate:(NSDate *)date appCode:(NSString *)appCode;
 ...
 */
- (void)setUserId:(NSString *)userId __attribute__ ((unavailable("Use PWInAppManager setUserId method instead")));
 ...
 */
- (void)mergeUserId:(NSString *)oldUserId to:(NSString *)newUserId doMerge:(BOOL)doMerge completion:(void (^)(NSError *error))completion __attribute__ ((unavailable("Use PWInAppManager mergeUserId method instead")));
 ...
 */
- (void)postEvent:(NSString *)event withAttributes:(NSDictionary *)attributes completion:(void (^)(NSError *error))completion __attribute__ ((unavailable("Use PWInAppManager postEvent method instead")));
...
/**
 ...
 Deprecated. Use PWInAppManager postEvent method instead
 */
- (void)postEvent:(NSString *)event withAttributes:(NSDictionary *)attributes __attribute__ ((unavailable("Use PWInAppManager postEvent method instead")));
